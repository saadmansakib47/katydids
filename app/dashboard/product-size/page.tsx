...
import { ProductSizeCalculator } from "@/components/metrics/ProductSizeCalculator";
import { motion } from "framer-motion";

export default function ProductSizePage() {
  const subtitle = useTypewriter("Calculate basic, Halstead, FPA, and complexity metrics.", 40);
